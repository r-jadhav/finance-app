...
const signUpValidationSchema = yup.object().shape({
  personal_loan_name: yup.string().required(i18n.t('Full_name_is_required')),
  personal_loan_phone: yup.string().required(i18n.t('Phone_number_is_required')),
  personal_loan_email: yup.string().required(i18n.t('Email_is_required')),
  personal_loan_income: yup.string().required(i18n.t('Salary_is_required')),
  personal_loan_address: yup.string().required(i18n.t('Address_is_required')),
});
  ...
  const createPost = values => {
    ...
    axios
      .post('http://finedict.com:3000/LoanEnquiryService', {
        personal_loan_name: values.personal_loan_name,
        personal_loan_email: values.personal_loan_email,
        personal_loan_phone: values.personal_loan_phone,
        personal_loan_income: values.personal_loan_income,
        personal_loan_department: values.personal_loan_department,
        personal_loan_address: values.personal_loan_address,

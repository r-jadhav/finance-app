...
const SecuredOverdraftLimit = ({navigation}) => {
  ...
  const createPost = (values)=> {
    ...
    //   se_draft_name:values.se_draft_name,
    //   se_draft_email:values.se_draft_email,
    //   se_draft_phone:values.se_draft_phone,
    //   se_draft_agriculture:values.se_draft_agriculture,
    //   se_draft_itr:values.se_draft_itr,
    //   se_draft_address:values.se_draft_address,
  ...
  return (
    <>
      ...
      <SafeAreaView style={styles.container}>
          ...
          fontFamily:'Poppins-SemiBold'}}>{i18n.t('Secured_Overdraft_Limit')}</Text>
              ...
              >
                {({ handleSubmit, isValid, values }) => (
                  ...
                  <Field
                      ...
                      title = "Agriculture Land 2 Bigha"
                      first_name="Yes"
                      second_name = "No"
                      value1="YES"
                      value2="NO"
...
export default SecuredOverdraftLimit